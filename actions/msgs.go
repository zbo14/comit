...
const (
	...
	invalid_formID      = "<span style='color:red;'>Invalid form ID <really-small>%X</really-small></span>"
	...
	submit_form_success = "Submitted form with ID <really-small>%X</really-small>"

	form_already_exists = "<span style='color:red;'>Form already exists</span>"

	find_form_failure   = "<span style='color:red;'>Failed to find form with ID <really-small>%X</really-small></span>"
	decode_form_failure = "<span style='color:red;'>Failed to decode form with ID <really-small>%X</really-small></span>"
